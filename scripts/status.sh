...
check_health "roach-weatherlink-ingest-to-kafka" "WeatherLink Ingest to Kafka"
check_health "roach-weatherlink-materialize-to-sql" "WeatherLink Materialize to SQL"
...
echo "  Restart service:  ./scripts/restart-all.sh <service>"
