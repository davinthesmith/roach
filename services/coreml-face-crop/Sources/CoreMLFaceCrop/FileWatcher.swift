...
/// Watches a directory for new .jpg files using macOS FSEvents.
final class FileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.roach.coreml-face-crop.filewatcher")
...
/// FSEvents C callback — bridges to the FileWatcher instance.
