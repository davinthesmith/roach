...
// PublishRaw publishes raw JSON bytes to a Kafka topic with key and headers.
func (p *Producer) PublishRaw(ctx context.Context, topic string, key string, data []byte, headers map[string]string) error {
