...
**Service Name**: `weatherlink-materialize-to-sql` (Docker service)  
**Binary Name**: `weather-sql` (internal Go module and executable)  
**Container Name**: `roach-weatherlink-materialize-to-sql`
...
```bash
# From project root
docker compose up weatherlink-materialize-to-sql
```

### Standalone with Go

```bash
cd services/weatherlink-materialize-to-sql
...
```bash
# View logs
docker compose logs -f weatherlink-materialize-to-sql

# Check if running
docker compose ps weatherlink-materialize-to-sql
...
```bash
# Check logs
docker compose logs weatherlink-materialize-to-sql
...
If "missing_device":
- Ensure weatherlink-ingest-to-kafka service is running
