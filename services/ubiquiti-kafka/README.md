...
```
UniFi Protect NVR (WebSocket) → ubiquiti-kafka → Kafka
         ↑                            ↑
...
| Topic | Content |
|-------|---------|
| `ubiquiti.protect.smart` | Video AI: person, vehicle, animal, package |
| `ubiquiti.protect.audio` | Audio AI: babyCry, coAlarm, smoke, speak |
