...
Only one video stream service should run at a time: use either **unifi-video-jpg** (files) or **unifi-video-kafka** (Kafka). The default docker-compose runs unifi-video-jpg and has unifi-video-kafka commented out.
